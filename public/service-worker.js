            ...
            ({
                1: [function(e, t, n) {
                        ...
                        t.exports = {
                            ...
                            isResponseFresh: function(e, t, n) { if (!e) return !1; if (t) { var r = e.headers.get("date"); if (r && new Date(r).getTime() + 1e3 * t < n) return !1 } return !0 }
                        }
                    },
                    ...
                    ["get", "post", "put", "delete", "head", "any"].forEach(function(e) {
                        ...
                        c.prototype.matchMethod = function(e, t) {
                            var n = new URL(t),
                                r = n.origin,
                                a = n.pathname;
                            return this._match(e, o(this.routes, r), a) || this._match(e, [this.routes.get(RegExp)], t)
                        }, c.prototype._match = function(e, t, n) {
                            if (0 === t.length)
                                return null;
                            for (var r = 0; r < t.length; r++) {
                                var a = t[r],
                                    c = a && a.get(e.toLowerCase());
                                if (c) {
                                    var s = o(c, n);
                                    if (s.length > 0)
                ...
                15: [function(e, t, n) {
                    function r(e, t) {
                        for (var n, r = [],
                                a = 0, o = 0,
                                c = "",
                                u = t && t.delimiter || "/"; null != (n = l.exec(e));) {
                            var f = n[0],
                                h = n[1],
                                p = n.index;
                            if (c += e.slice(o, p),
                                o = p + f.length, h) c += h[1];
                            else {
                                var d = e[o],
                                    g = n[2],
                                    m = n[3],
