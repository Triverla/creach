    ...
    <div class="content-wrapper">
        <header class="header" id="site-header">
            <div class="container">
                    <div class="header-content-wrapper">
                        <div class="logo">
                            <div class="logo-text">
                                <div class="logo-title"><a href="/">Creach</a></div>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
               <!-- <div class="heading text-center">
                        <h1 class="heading-title" style="color:darkcyan">-- CREACH --</h1> 
           ...
           <h2 class="text-center">OOPS!!! You are Offline!</h2>
           <hr>
           <h3 class="text-center">If you saved any content offline, you can access it here</h3>
           <p class="text-center">Offline Articles Coming soon</p>
           <p class="text-center">Double Check your network connection and try again  <br>
        <button type="button" class="btn btn-primary btn--blue" onclick="document.reload();">Try Again</button></p>
        <!-- End Subscribe Form -->
    </div>
    <!-- Footer -->
            ...
            <div class="row">
                <div class="info">
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="heading text-center">
                            <h3 class="heading-title" >Creach</h3>
                            <div class="heading-line">
                                <span class="short-line"></span>
                                <span class="long-line"></span>
                            </div>
                ...
                <div class="contacts">
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">08147323591</a>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">cranium@gmail.com</a>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">Abuja, Nigeria</a>
